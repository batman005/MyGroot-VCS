...
//line 1 is shabang which help to run the file directly in terminal
...
class Groot {
    ...
    async updateStagingArea(filePath, fileHash) {
        ...
        index.push({ path: filePath, hash: fileHash });// add the file the index
...
//     await groot.showCommitDiff('77d3d2b186ce7d088ecde6b63c574b1fbfadffa9');
...
//process.argv show command line arg
